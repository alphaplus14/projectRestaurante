    ...
    >
      <span
        className={classNames(
          ...
          // Usuarios → violeta para diferenciarlo visualmente
          to.includes("/usuarios")
            ? "bg-violet-500"
      ...
      />
      <span className={classNames("truncate", collapsed ? "hidden" : "block")}>
        {label}
      </span>
    </NavLink>
  );
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-50">
      <div className="flex min-h-screen">
        <aside
          className={classNames(
            "shrink-0 border-r border-stone-800 bg-stone-900",
            sidebarWidth,
          )}
        >
