...
export function LoginCocinaPage() {
    ...
    return (
        <div className="min-h-screen bg-stone-950 text-stone-100">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(217,119,6,0.18),transparent_50%),radial-gradient(ellipse_at_bottom,rgba(194,65,12,0.12),transparent_55%)]" />
                ...
                <div className="w-full grid lg:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <p className="mt-4 text-stone-300 leading-relaxed max-w-prose">
                            ...
                            <span className="text-stone-200 font-medium">listo para servir</span>.
                        </p>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="text-sm text-stone-400">Rol cocina</div>
                                </div>
                                <div className="h-10 w-10 rounded-xl bg-orange-500/20 border border-orange-400/30 flex items-center justify-center text-orange-200 font-bold">
                                    K
                                </div>
                            </div>
                            ...
                            <form className="mt-6 space-y-4" onSubmit={onSubmit}>
                                <div>
                                    ...
                                    <input
                                        className={classNames(
                                            ...
                                            'border-white/10 focus:border-orange-400/40 focus:ring-2 focus:ring-orange-400/15',
                                        )}
                                        autoComplete="email"
                                        value={correo}
                                ...
                                <div className="text-xs text-stone-500">
                                    Solo usuarios con rol <span className="text-stone-300">COCINERO</span>.
                                </div>
                            </form>
                        </div>
                    </div>
