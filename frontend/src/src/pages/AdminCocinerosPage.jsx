...
export function AdminCocinerosPage() {
    ...
    async function load() {
        ...
        try {
            ...
            setError(err?.message || 'No se pudo cargar cocineros.');
        } finally {
            setLoading(false);
        }
    }
    ...
    if (loading) {
        return (
            <AdminLayout title="Cocineros">
                <div className="flex items-center justify-center text-stone-400 text-lg py-20">Cargando cocineros…</div>
            </AdminLayout>
        );
    }
        ...
        <AdminLayout title="Cocineros">
            <div className="flex items-start justify-between gap-6 flex-wrap">
                <div>
                    ...
                    <div className="mt-2 text-stone-400">Crea, edita o deshabilita cocineros (sin eliminarlos).</div>
                </div>
                <button
                    onClick={openCreate}
